...
public class EntityUtil {
	...
	private final String moduleName = "mall"; // 数据库名称

	private final String bean_path = "C:\\Users\\lenovo\\Desktop\\实训标准代码\\seckill-parent\\seckill-service\\src\\main\\java";

	private final String mapper_path = "C:\\Users\\lenovo\\Desktop\\实训标准代码\\seckill-parent\\seckill-service\\src\\main\\java\\org\\yfmw\\seckill\\common\\dao";

	private final String xml_path = "C:\\Users\\lenovo\\Desktop\\实训标准代码\\seckill-parent\\seckill-service\\src\\main\\resources\\mapping";// xml路径

	private final String model_package = "org.yfmw.seckill.common.model";// model的包所在

	private final String dao_package = "org.yfmw.seckill.common.dao";// dao的包所在
	...
	String url = "jdbc:mysql://localhost:3306/" + moduleName
			+ "?serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf8&autoReconnect=true&useSSL=false&failOverReadOnly=false";
